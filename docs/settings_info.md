...
DATABASES = { 'default': { 'ENGINE': 'django.db.backends.postgresql', # if use postgresql
    'NAME': config('DB_NAME'),
    'USER': config('DB_USER'),
...
STATIC_ROOT = BASE_DIR / 'static' # if using cloudinary
...
MEDIA_URL = '/TeamsApp/' # if use cloudinary LOGIN_URL = '/players/login/' LOGIN_REDIRECT_URL = 'players/teams/'
